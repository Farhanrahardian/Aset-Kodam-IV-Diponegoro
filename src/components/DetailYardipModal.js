    ...
    <Modal show={show} onHide={onHide} size="xl" centered>
      ...
      <Modal.Body>
        <Row>
          <Col md={6}>
            <Card>
              <Card.Header><h5>Informasi Aset</h5></Card.Header>
              <Card.Body>
          ...
          <Col md={6}>
            <Card className="h-100">
              <Card.Header><h5>Lokasi Peta</h5></Card.Header>
                ...
                <div style={{ height: '100%', minHeight: '400px' }}>
                  {hasValidLocation ? (
                    ...
                    >
                      ...
                      <Polygon positions={mapGeometry.coordinates[0]} pathOptions={getPolygonStyleByStatus(asset.status)} />
